                    ...
                    <div class="checkout-billing-details-wrap">
                        ...
                        <div class="billing-form-wrap">
                                ...
                                <div class="single-input-item">
                                    ...
                                    <input type="text" id="sdt_nguoi_nhan" name="so_dien_thoai" value="<?= $user['so_dien_thoai'] ?>" placeholder="SĐT người nhận" required />
                                </div>
                                <div class="single-input-item">
                                ...
                                <div class="single-payment-method show">
                                    <div class="payment-method-name">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" id="cashon" name="paymentmethod" value="cash" name="phuong_thuc_thanh_toan" class="custom-control-input" checked />
                                            <label class="custom-control-label" for="cashon">Thanh toán khi nhận hàng</label>
                                        </div>
                                    </div>
                                    <div class="payment-method-details" data-method="cash">
                                        <p>Khách hàng có thể thanh toán sau khi đãn nhận hàng thành công(Cần xác nhận đơn hàng)</p>
                                    </div>
                                </div>
                                <div class="single-payment-method">
                                    <div class="payment-method-name">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" id="directbank" name="paymentmethod" name="phuong_thuc_thanh_toan" value="bank" class="custom-control-input" />
