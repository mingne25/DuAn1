      ...
      <div class="row">
        <div class="col-4">
          <img src="<?= BASE_URL . $khachHang['anh_dai_dien']  ?>" style="width:70%" alt=""
            onerror="this.onerorr=null; this.src='https://cdn-icons-png.freepik.com/512/3135/3135715.png?ga=GA1.1.86215592.1717158527'">
        </div>
        <div class="col-8">
          <div class="container">
                    ...
                    <td>
                      <div class="btn-group" style="display: flex;gap:5px;">
                        <a href="<?= BASE_URL_ADMIN . '?act=from-sua-don-hang&id_don_hang=' . $donHang['id'] ?>">
                          <button class="btn btn-warning"><i class="fa fa-wrench"></i></button></a>
